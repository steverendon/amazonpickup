...
<!-- carrusel -->
    <div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <a href="index.php?view=pagina&v=planes"><img class="d-block w-100" src="web/img/banner/web-amazon10.png" alt="First slide"></a>
        </div>
      </div>
    </div>
    ...
    <br>
    <div class="row justify-content-center">
        <div class="col-lg-10" style="padding: 3%">
    ...
    <a href="index.php?view=pagina&v=planes"><img src="web/img/image/amazon-14.png" class="img-fluid"></a>
